...
def get_args_parser():
    ...
    parser.add_argument('--local_crops_scale', type=float, nargs='+', default=(0.05, 0.5),
        help="""Scale range of the cropped image before resizing, relatively to the origin image.
    ...
    parser.add_argument('--output_dir', default="./exp_patch", type=str, help='Path to save logs and checkpoints.')
...
def train_dino(args):
    ...
    dataset  = Cell_masked_patches(data_path,label_id_path_file,train=True,sup_train=False, transform=transform)
    ...
    utils.restart_from_checkpoint(
        os.path.join(args.output_dir, "checkpoint_main.pth"),
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        utils.save_on_master(save_dict, os.path.join(args.output_dir, 'checkpoint_main.pth'))
...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number):
        ...
        self.global_transfo1 = transforms.Compose([
            ...
            transforms.RandomResizedCrop(112, scale=global_crops_scale, interpolation=Image.BICUBIC),
